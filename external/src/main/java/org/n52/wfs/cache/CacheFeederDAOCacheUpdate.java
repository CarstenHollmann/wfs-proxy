...
public abstract class CacheFeederDAOCacheUpdate extends ContentCacheUpdate {
    private final WfsCacheFeederHandler cacheFeederDAO;

    public CacheFeederDAOCacheUpdate(WfsCacheFeederHandler cacheFeederDAO) {
        this.cacheFeederDAO = cacheFeederDAO;
    }

    public WfsCacheFeederHandler getCacheFeederDAO() {
