...
public class DescribeStoredQueriesResponseEncoder extends AbstractWfsResponseEncoder<DescribeStoredQueriesResponse> {
    ...
    @Override
    protected XmlObject create(DescribeStoredQueriesResponse response) throws OwsExceptionReport {
        DescribeStoredQueriesResponseDocument describeStoredQueriesResponseDoc = DescribeStoredQueriesResponseDocument.Factory.newInstance(XmlOptionsHelper.getInstance().getXmlOptions());
        DescribeStoredQueriesResponseType describeStoredQueriesResponseType = describeStoredQueriesResponseDoc.addNewDescribeStoredQueriesResponse();
