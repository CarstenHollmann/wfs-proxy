...
public class ListStoredQueriesResponseEncoder extends AbstractWfsResponseEncoder<ListStoredQueriesResponse> {
    ...
    @Override
    protected XmlObject create(ListStoredQueriesResponse response) throws OwsExceptionReport {
        ListStoredQueriesResponseDocument listStoredQueriesResponseDoc = ListStoredQueriesResponseDocument.Factory.newInstance(XmlOptionsHelper.getInstance().getXmlOptions());
        ListStoredQueriesResponseType listStoredQueriesResponseType = listStoredQueriesResponseDoc.addNewListStoredQueriesResponse();
