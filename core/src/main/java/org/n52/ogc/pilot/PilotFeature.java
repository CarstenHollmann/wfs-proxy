...
public class PilotFeature extends AbstractFeature {


    public PilotFeature(String identifier) {
        super(identifier);
    }
     ...
     *            Feature identifier
     */
    public PilotFeature(CodeWithAuthority featureIdentifier) {
     ...
     *            GML id
     */
    public PilotFeature(CodeWithAuthority featureIdentifier, String gmlId) {
