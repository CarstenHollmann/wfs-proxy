 ...
 * 
 */
public class WfsListStoredQueriesOperatorV20 extends
AbstractV2RequestOperator<AbstractListStoredQueriesDAO, ListStoredQueriesRequest, ListStoredQueriesResponse> {
    ...
    public WfsListStoredQueriesOperatorV20() {
        super(OPERATION_NAME, ListStoredQueriesRequest.class);
    }
    ...
    protected ListStoredQueriesResponse receive(ListStoredQueriesRequest request) throws OwsExceptionReport {
        return getDao().listStoredQueries(request);
    }
