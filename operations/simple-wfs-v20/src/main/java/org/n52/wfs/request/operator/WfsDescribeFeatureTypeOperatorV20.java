...
public class WfsDescribeFeatureTypeOperatorV20
        extends
        AbstractV2RequestOperator<AbstractDescribeFeatureTypeDAO, DescribeFeatureTypeRequest, DescribeFeatureTypeResponse> {
    ...
    public WfsDescribeFeatureTypeOperatorV20() {
        super(OPERATION_NAME, DescribeFeatureTypeRequest.class);
    }
    ...
    protected DescribeFeatureTypeResponse receive(DescribeFeatureTypeRequest request) throws OwsExceptionReport {
        return getDao().describeFeatureType(request);
    }
