...
public class WfsDispatcherServlet extends DispatcherServlet implements ContextSwitcher {
    private static final long serialVersionUID = -5393279536808296529L;

    private static final Logger LOG = LoggerFactory.getLogger(WfsDispatcherServlet.class);
